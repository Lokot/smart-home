  ...
  public class Messages
  {
    ...
    public static String getString(String bundle1, String bundle2, String resourceId, Locale locale, ClassLoader loader, Object[] params)
    {
      ...
      if (bundle1 != null)
      {
        ResourceBundle bundle = ResourceBundle.getBundle(bundle1, locale, loader);
        if (bundle != null) {
          try
          {
      ...
      if (resource == null)
      {
        ResourceBundle bundle = ResourceBundle.getBundle(bundle2, locale, loader);
        if (bundle != null) {
          try
          {
            resource = bundle.getString(resourceId);
