...
public class ConfigPropertyForm extends AbstractForm<JpaProperty> {
	...
	protected Collection<? extends Component> getInputs() {
		...
		propertyType = new ComboBox("Тип свойства", Arrays.asList(Integer.class.getName(), Float.class.getName(),
				Double.class.getName(), Date.class.getName(), String.class.getName()));
