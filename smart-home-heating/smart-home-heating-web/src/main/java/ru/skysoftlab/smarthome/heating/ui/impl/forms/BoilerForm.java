...
public class BoilerForm extends AbstractDeviceForm<Boiler> {
	...
	protected Collection<Component> getAddonInputs() {
		...
		Button addGpio = new Button("Добавить датчик", new Button.ClickListener() {
		...
		HorizontalLayout mainLayout = new HorizontalLayout(sensorsBox, gridButtons);
