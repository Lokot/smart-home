...
public class JpaPropertyEntityProviderBean extends MutableLocalEntityProvider<JpaProperty> {
	...
	public JpaPropertyEntityProviderBean() {
	...
	public void init() {
		setEntityManager(em);
		/*
		 * The entity manager is transaction-scoped, which means that the entities will
		 * be automatically detached when the transaction is closed. Therefore, we do
		 * not need to explicitly detach them.
		 */
